...
// const signer1.address = "0x9169EC9DA721f7f50bDfCF33db21BAECbe64c284";
// const signer2.address = "0xB6eAC6aE0ecC111AF8804e9587b9f8b85Bd8B25e";

async function main() {
    // Deploy Token smart contract
    let TokenContractDeployed = false;
    ...
    // Deploy the token contract factory
        ...
        // Check the token balance after the Mint
